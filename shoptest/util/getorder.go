...
func GetOrderJson1(name, apikey, secret string) (str string) {
	url := "https://" + apikey + ":" + secret + "@" + name + ".myshopify.com/"
...
func GetOrderStruct1(name, apikey, secret string, i int) (Orders, ShippingAddress, []LineItems) {
	...
	beego.Alert(i)
	url := "https://" + apikey + ":" + secret + "@" + name + ".myshopify.com/"
	orderurl := url + GetOrderInfo + "&ids=" + ids[0]
