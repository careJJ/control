...
func init(){
	...
	orm.RegisterModel(new(User),new(Address),new(TpshopCategory),new(IndexPromotionBanner),new(IndexTypeGoodsBanner),new(IndexGoodsBanner),new(GoodsImage),new(GoodsSKU),new(GoodsType),new(Goods),new(OrderGoods),new(OrderInfo))
